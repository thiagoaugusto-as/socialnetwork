...
CREATE TABLE `post_comments` (
  ...
  `id_post` int(45) DEFAULT NULL,
  `id_user` int(45) DEFAULT NULL,
...
CREATE TABLE `user_relations` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `user_from` int(45) DEFAULT NULL,
  `user_to` int(45) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `users` (
  ...
  `avatar` varchar(100) CHARACTER SET utf8 DEFAULT 'default.jpg',
